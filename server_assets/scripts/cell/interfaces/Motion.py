...
class Motion:
	...
	def AnimUpdate(self, data):
		"""
		"""	
		self.otherClients.OnAnimUpdate(data)

	def HoverCarMoveSpeedUpdate(self, data):
		"""
		"""	
		self.otherClients.OnHoverCarMoveSpeedUpdate(data)

	def StageAnimUpdate(self, data):
		"""
		"""	
		self.otherClients.OnStageAnimUpdate(data)
