...
namespace KBEngine
{
	...
	public class DATATYPE_ANIM_INFO : DATATYPE_BASE
	{
		public ANIM_INFO createFromStreamEx(MemoryStream stream)
		{
			ANIM_INFO datas = new ANIM_INFO();
			datas.Speed = stream.readFloat();
			datas.Direction = stream.readFloat();
			return datas;
		}

		public void addToStreamEx(Bundle stream, ANIM_INFO v)
		{
	...
	public class DATATYPE_STAGEANIM_INFO : DATATYPE_BASE
	{
		public STAGEANIM_INFO createFromStreamEx(MemoryStream stream)
		{
			STAGEANIM_INFO datas = new STAGEANIM_INFO();
			datas.Speed = stream.readFloat();
			datas.Direction = stream.readFloat();
			datas.IsInAir = stream.readUint8();
			datas.MaxSpeed = stream.readFloat();
			datas.CurAcceleration = stream.readVector3();
			datas.InputVector = stream.readVector3();
			return datas;
		}

		public void addToStreamEx(Bundle stream, STAGEANIM_INFO v)
		{
			stream.writeFloat(v.Speed);
			stream.writeFloat(v.Direction);
			stream.writeUint8(v.IsInAir);
			stream.writeFloat(v.MaxSpeed);
			stream.writeVector3(v.CurAcceleration);
			stream.writeVector3(v.InputVector);
		}
	}



	public class DATATYPE_HOVERCAR_INFO : DATATYPE_BASE
	{
		public HOVERCAR_INFO createFromStreamEx(MemoryStream stream)
		{
			HOVERCAR_INFO datas = new HOVERCAR_INFO();
			datas.Speed = stream.readFloat();
			return datas;
		}

		public void addToStreamEx(Bundle stream, HOVERCAR_INFO v)
		{
			stream.writeFloat(v.Speed);
		}
	}
