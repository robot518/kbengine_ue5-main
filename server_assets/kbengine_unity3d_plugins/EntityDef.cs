...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			List<DATATYPE_BASE> pAvatar_OnAnimUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_OnAnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pAvatar_OnAnimUpdate = new Method();
			pAvatar_OnAnimUpdate.name = "OnAnimUpdate";
			pAvatar_OnAnimUpdate.methodUtype = 12;
			pAvatar_OnAnimUpdate.aliasID = 1;
			pAvatar_OnAnimUpdate.args = pAvatar_OnAnimUpdate_args;

			pAvatarModule.methods["OnAnimUpdate"] = pAvatar_OnAnimUpdate; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_OnAnimUpdate.aliasID] = pAvatar_OnAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(OnAnimUpdate / 12).");

			List<DATATYPE_BASE> pAvatar_OnHoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_OnHoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pAvatar_OnHoverCarMoveSpeedUpdate = new Method();
			pAvatar_OnHoverCarMoveSpeedUpdate.name = "OnHoverCarMoveSpeedUpdate";
			pAvatar_OnHoverCarMoveSpeedUpdate.methodUtype = 13;
			pAvatar_OnHoverCarMoveSpeedUpdate.aliasID = 2;
			pAvatar_OnHoverCarMoveSpeedUpdate.args = pAvatar_OnHoverCarMoveSpeedUpdate_args;

			pAvatarModule.methods["OnHoverCarMoveSpeedUpdate"] = pAvatar_OnHoverCarMoveSpeedUpdate; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_OnHoverCarMoveSpeedUpdate.aliasID] = pAvatar_OnHoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(OnHoverCarMoveSpeedUpdate / 13).");

			List<DATATYPE_BASE> pAvatar_OnStageAnimUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_OnStageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pAvatar_OnStageAnimUpdate = new Method();
			pAvatar_OnStageAnimUpdate.name = "OnStageAnimUpdate";
			pAvatar_OnStageAnimUpdate.methodUtype = 14;
			pAvatar_OnStageAnimUpdate.aliasID = 3;
			pAvatar_OnStageAnimUpdate.args = pAvatar_OnStageAnimUpdate_args;

			pAvatarModule.methods["OnStageAnimUpdate"] = pAvatar_OnStageAnimUpdate; 
			pAvatarModule.useMethodDescrAlias = true;
			pAvatarModule.idmethods[(UInt16)pAvatar_OnStageAnimUpdate.aliasID] = pAvatar_OnStageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(OnStageAnimUpdate / 14).");
			...
			pAvatar_dialog_addOption.aliasID = 4;
			...
			pAvatar_dialog_close.aliasID = 5;
			...
			pAvatar_dialog_setText.aliasID = 6;
			...
			pAvatar_onAddSkill.methodUtype = 18;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onAddSkill / 18).");
			...
			pAvatar_onRemoveSkill.methodUtype = 19;
			pAvatar_onRemoveSkill.aliasID = 9;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(onRemoveSkill / 19).");
			...
			pAvatar_recvDamage.methodUtype = 22;
			pAvatar_recvDamage.aliasID = 10;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(recvDamage / 22).");

			List<DATATYPE_BASE> pAvatar_AnimUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_AnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pAvatar_AnimUpdate = new Method();
			pAvatar_AnimUpdate.name = "AnimUpdate";
			pAvatar_AnimUpdate.methodUtype = 9;
			pAvatar_AnimUpdate.aliasID = -1;
			pAvatar_AnimUpdate.args = pAvatar_AnimUpdate_args;

			pAvatarModule.methods["AnimUpdate"] = pAvatar_AnimUpdate; 
			pAvatarModule.cell_methods["AnimUpdate"] = pAvatar_AnimUpdate;

			pAvatarModule.idcell_methods[pAvatar_AnimUpdate.methodUtype] = pAvatar_AnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(AnimUpdate / 9).");

			List<DATATYPE_BASE> pAvatar_HoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_HoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pAvatar_HoverCarMoveSpeedUpdate = new Method();
			pAvatar_HoverCarMoveSpeedUpdate.name = "HoverCarMoveSpeedUpdate";
			pAvatar_HoverCarMoveSpeedUpdate.methodUtype = 10;
			pAvatar_HoverCarMoveSpeedUpdate.aliasID = -1;
			pAvatar_HoverCarMoveSpeedUpdate.args = pAvatar_HoverCarMoveSpeedUpdate_args;

			pAvatarModule.methods["HoverCarMoveSpeedUpdate"] = pAvatar_HoverCarMoveSpeedUpdate; 
			pAvatarModule.cell_methods["HoverCarMoveSpeedUpdate"] = pAvatar_HoverCarMoveSpeedUpdate;

			pAvatarModule.idcell_methods[pAvatar_HoverCarMoveSpeedUpdate.methodUtype] = pAvatar_HoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(HoverCarMoveSpeedUpdate / 10).");

			List<DATATYPE_BASE> pAvatar_StageAnimUpdate_args = new List<DATATYPE_BASE>();
			pAvatar_StageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pAvatar_StageAnimUpdate = new Method();
			pAvatar_StageAnimUpdate.name = "StageAnimUpdate";
			pAvatar_StageAnimUpdate.methodUtype = 11;
			pAvatar_StageAnimUpdate.aliasID = -1;
			pAvatar_StageAnimUpdate.args = pAvatar_StageAnimUpdate_args;

			pAvatarModule.methods["StageAnimUpdate"] = pAvatar_StageAnimUpdate; 
			pAvatarModule.cell_methods["StageAnimUpdate"] = pAvatar_StageAnimUpdate;

			pAvatarModule.idcell_methods[pAvatar_StageAnimUpdate.methodUtype] = pAvatar_StageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(StageAnimUpdate / 11).");
			...
			pAvatar_requestPull.methodUtype = 17;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), method(requestPull / 17).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(helloCB / 34).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(say / 33).");
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), method(hello / 32).");
			...
			pTestNoBase_helloCB.methodUtype = 36;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(helloCB / 36).");
			...
			pTestNoBase_hello.methodUtype = 35;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), method(hello / 35).");
			...
			List<DATATYPE_BASE> pMonster_OnAnimUpdate_args = new List<DATATYPE_BASE>();
			pMonster_OnAnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pMonster_OnAnimUpdate = new Method();
			pMonster_OnAnimUpdate.name = "OnAnimUpdate";
			pMonster_OnAnimUpdate.methodUtype = 41;
			pMonster_OnAnimUpdate.aliasID = 1;
			pMonster_OnAnimUpdate.args = pMonster_OnAnimUpdate_args;

			pMonsterModule.methods["OnAnimUpdate"] = pMonster_OnAnimUpdate; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_OnAnimUpdate.aliasID] = pMonster_OnAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(OnAnimUpdate / 41).");

			List<DATATYPE_BASE> pMonster_OnHoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pMonster_OnHoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pMonster_OnHoverCarMoveSpeedUpdate = new Method();
			pMonster_OnHoverCarMoveSpeedUpdate.name = "OnHoverCarMoveSpeedUpdate";
			pMonster_OnHoverCarMoveSpeedUpdate.methodUtype = 42;
			pMonster_OnHoverCarMoveSpeedUpdate.aliasID = 2;
			pMonster_OnHoverCarMoveSpeedUpdate.args = pMonster_OnHoverCarMoveSpeedUpdate_args;

			pMonsterModule.methods["OnHoverCarMoveSpeedUpdate"] = pMonster_OnHoverCarMoveSpeedUpdate; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_OnHoverCarMoveSpeedUpdate.aliasID] = pMonster_OnHoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(OnHoverCarMoveSpeedUpdate / 42).");

			List<DATATYPE_BASE> pMonster_OnStageAnimUpdate_args = new List<DATATYPE_BASE>();
			pMonster_OnStageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pMonster_OnStageAnimUpdate = new Method();
			pMonster_OnStageAnimUpdate.name = "OnStageAnimUpdate";
			pMonster_OnStageAnimUpdate.methodUtype = 43;
			pMonster_OnStageAnimUpdate.aliasID = 3;
			pMonster_OnStageAnimUpdate.args = pMonster_OnStageAnimUpdate_args;

			pMonsterModule.methods["OnStageAnimUpdate"] = pMonster_OnStageAnimUpdate; 
			pMonsterModule.useMethodDescrAlias = true;
			pMonsterModule.idmethods[(UInt16)pMonster_OnStageAnimUpdate.aliasID] = pMonster_OnStageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(OnStageAnimUpdate / 43).");
			...
			List<DATATYPE_BASE> pMonster_AnimUpdate_args = new List<DATATYPE_BASE>();
			pMonster_AnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pMonster_AnimUpdate = new Method();
			pMonster_AnimUpdate.name = "AnimUpdate";
			pMonster_AnimUpdate.methodUtype = 38;
			pMonster_AnimUpdate.aliasID = -1;
			pMonster_AnimUpdate.args = pMonster_AnimUpdate_args;

			pMonsterModule.methods["AnimUpdate"] = pMonster_AnimUpdate; 
			pMonsterModule.cell_methods["AnimUpdate"] = pMonster_AnimUpdate;

			pMonsterModule.idcell_methods[pMonster_AnimUpdate.methodUtype] = pMonster_AnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(AnimUpdate / 38).");

			List<DATATYPE_BASE> pMonster_HoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pMonster_HoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pMonster_HoverCarMoveSpeedUpdate = new Method();
			pMonster_HoverCarMoveSpeedUpdate.name = "HoverCarMoveSpeedUpdate";
			pMonster_HoverCarMoveSpeedUpdate.methodUtype = 39;
			pMonster_HoverCarMoveSpeedUpdate.aliasID = -1;
			pMonster_HoverCarMoveSpeedUpdate.args = pMonster_HoverCarMoveSpeedUpdate_args;

			pMonsterModule.methods["HoverCarMoveSpeedUpdate"] = pMonster_HoverCarMoveSpeedUpdate; 
			pMonsterModule.cell_methods["HoverCarMoveSpeedUpdate"] = pMonster_HoverCarMoveSpeedUpdate;

			pMonsterModule.idcell_methods[pMonster_HoverCarMoveSpeedUpdate.methodUtype] = pMonster_HoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(HoverCarMoveSpeedUpdate / 39).");

			List<DATATYPE_BASE> pMonster_StageAnimUpdate_args = new List<DATATYPE_BASE>();
			pMonster_StageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pMonster_StageAnimUpdate = new Method();
			pMonster_StageAnimUpdate.name = "StageAnimUpdate";
			pMonster_StageAnimUpdate.methodUtype = 40;
			pMonster_StageAnimUpdate.aliasID = -1;
			pMonster_StageAnimUpdate.args = pMonster_StageAnimUpdate_args;

			pMonsterModule.methods["StageAnimUpdate"] = pMonster_StageAnimUpdate; 
			pMonsterModule.cell_methods["StageAnimUpdate"] = pMonster_StageAnimUpdate;

			pMonsterModule.idcell_methods[pMonster_StageAnimUpdate.methodUtype] = pMonster_StageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(StageAnimUpdate / 40).");
			...
			List<DATATYPE_BASE> pNPC_OnAnimUpdate_args = new List<DATATYPE_BASE>();
			pNPC_OnAnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pNPC_OnAnimUpdate = new Method();
			pNPC_OnAnimUpdate.name = "OnAnimUpdate";
			pNPC_OnAnimUpdate.methodUtype = 57;
			pNPC_OnAnimUpdate.aliasID = 1;
			pNPC_OnAnimUpdate.args = pNPC_OnAnimUpdate_args;

			pNPCModule.methods["OnAnimUpdate"] = pNPC_OnAnimUpdate; 
			pNPCModule.useMethodDescrAlias = true;
			pNPCModule.idmethods[(UInt16)pNPC_OnAnimUpdate.aliasID] = pNPC_OnAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(OnAnimUpdate / 57).");

			List<DATATYPE_BASE> pNPC_OnHoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pNPC_OnHoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pNPC_OnHoverCarMoveSpeedUpdate = new Method();
			pNPC_OnHoverCarMoveSpeedUpdate.name = "OnHoverCarMoveSpeedUpdate";
			pNPC_OnHoverCarMoveSpeedUpdate.methodUtype = 58;
			pNPC_OnHoverCarMoveSpeedUpdate.aliasID = 2;
			pNPC_OnHoverCarMoveSpeedUpdate.args = pNPC_OnHoverCarMoveSpeedUpdate_args;

			pNPCModule.methods["OnHoverCarMoveSpeedUpdate"] = pNPC_OnHoverCarMoveSpeedUpdate; 
			pNPCModule.useMethodDescrAlias = true;
			pNPCModule.idmethods[(UInt16)pNPC_OnHoverCarMoveSpeedUpdate.aliasID] = pNPC_OnHoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(OnHoverCarMoveSpeedUpdate / 58).");

			List<DATATYPE_BASE> pNPC_OnStageAnimUpdate_args = new List<DATATYPE_BASE>();
			pNPC_OnStageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pNPC_OnStageAnimUpdate = new Method();
			pNPC_OnStageAnimUpdate.name = "OnStageAnimUpdate";
			pNPC_OnStageAnimUpdate.methodUtype = 59;
			pNPC_OnStageAnimUpdate.aliasID = 3;
			pNPC_OnStageAnimUpdate.args = pNPC_OnStageAnimUpdate_args;

			pNPCModule.methods["OnStageAnimUpdate"] = pNPC_OnStageAnimUpdate; 
			pNPCModule.useMethodDescrAlias = true;
			pNPCModule.idmethods[(UInt16)pNPC_OnStageAnimUpdate.aliasID] = pNPC_OnStageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(OnStageAnimUpdate / 59).");

			List<DATATYPE_BASE> pNPC_AnimUpdate_args = new List<DATATYPE_BASE>();
			pNPC_AnimUpdate_args.Add(EntityDef.id2datatypes[28]);

			Method pNPC_AnimUpdate = new Method();
			pNPC_AnimUpdate.name = "AnimUpdate";
			pNPC_AnimUpdate.methodUtype = 54;
			pNPC_AnimUpdate.aliasID = -1;
			pNPC_AnimUpdate.args = pNPC_AnimUpdate_args;

			pNPCModule.methods["AnimUpdate"] = pNPC_AnimUpdate; 
			pNPCModule.cell_methods["AnimUpdate"] = pNPC_AnimUpdate;

			pNPCModule.idcell_methods[pNPC_AnimUpdate.methodUtype] = pNPC_AnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(AnimUpdate / 54).");

			List<DATATYPE_BASE> pNPC_HoverCarMoveSpeedUpdate_args = new List<DATATYPE_BASE>();
			pNPC_HoverCarMoveSpeedUpdate_args.Add(EntityDef.id2datatypes[30]);

			Method pNPC_HoverCarMoveSpeedUpdate = new Method();
			pNPC_HoverCarMoveSpeedUpdate.name = "HoverCarMoveSpeedUpdate";
			pNPC_HoverCarMoveSpeedUpdate.methodUtype = 55;
			pNPC_HoverCarMoveSpeedUpdate.aliasID = -1;
			pNPC_HoverCarMoveSpeedUpdate.args = pNPC_HoverCarMoveSpeedUpdate_args;

			pNPCModule.methods["HoverCarMoveSpeedUpdate"] = pNPC_HoverCarMoveSpeedUpdate; 
			pNPCModule.cell_methods["HoverCarMoveSpeedUpdate"] = pNPC_HoverCarMoveSpeedUpdate;

			pNPCModule.idcell_methods[pNPC_HoverCarMoveSpeedUpdate.methodUtype] = pNPC_HoverCarMoveSpeedUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(HoverCarMoveSpeedUpdate / 55).");

			List<DATATYPE_BASE> pNPC_StageAnimUpdate_args = new List<DATATYPE_BASE>();
			pNPC_StageAnimUpdate_args.Add(EntityDef.id2datatypes[29]);

			Method pNPC_StageAnimUpdate = new Method();
			pNPC_StageAnimUpdate.name = "StageAnimUpdate";
			pNPC_StageAnimUpdate.methodUtype = 56;
			pNPC_StageAnimUpdate.aliasID = -1;
			pNPC_StageAnimUpdate.args = pNPC_StageAnimUpdate_args;

			pNPCModule.methods["StageAnimUpdate"] = pNPC_StageAnimUpdate; 
			pNPCModule.cell_methods["StageAnimUpdate"] = pNPC_StageAnimUpdate;

			pNPCModule.idcell_methods[pNPC_StageAnimUpdate.methodUtype] = pNPC_StageAnimUpdate;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), method(StageAnimUpdate / 56).");
		...
		public static void initDefTypes()
		{
			...
			{
				UInt16 utype = 28;
				string typeName = "ANIM_INFO";
				DATATYPE_ANIM_INFO datatype = new DATATYPE_ANIM_INFO();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 29;
				string typeName = "STAGEANIM_INFO";
				DATATYPE_STAGEANIM_INFO datatype = new DATATYPE_STAGEANIM_INFO();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 30;
				string typeName = "HOVERCAR_INFO";
				DATATYPE_HOVERCAR_INFO datatype = new DATATYPE_HOVERCAR_INFO();
				EntityDef.datatypes[typeName] = datatype;
				EntityDef.id2datatypes[utype] = EntityDef.datatypes[typeName];
				EntityDef.datatype2id[typeName] = utype;
			}
			...
			{
				UInt16 utype = 37;
				string typeName = "AnonymousArray_37";
				string name = "ENTITY_COMPONENT";
				DATATYPE_BASE val = null;
				EntityDef.datatypes.TryGetValue(name, out val);
				EntityDef.datatypes[typeName] = val;
			...
			{
				UInt16 utype = 38;
				string typeName = "AnonymousArray_38";
				string name = "ENTITY_COMPONENT";
				DATATYPE_BASE val = null;
				EntityDef.datatypes.TryGetValue(name, out val);
				EntityDef.datatypes[typeName] = val;
