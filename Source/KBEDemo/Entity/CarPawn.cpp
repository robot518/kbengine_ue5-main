...
void ACarPawn::BeginPlay()
{
	...
	if (XGameMode)
	{
		...
		XGameMode->addCarEntity(this->entityID, this);
...
void ACarPawn::updateLocation(float DeltaTime)
{
	...
	if (vectorDirection.Size() > deltaSpeed)
	{
		...
		SetActorLocation(currLocation + (vectorDirection * deltaSpeed), false, nullptr, ETeleportType::TeleportPhysics);
	}
	else
	{
...
void ACarPawn::FaceRotation(FRotator NewRotation, float DeltaTime)
{
...
void ACarPawn::setModelID(int sub_modelID)
{
